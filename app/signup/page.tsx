  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <Card className="bg-card border-border w-full max-w-md p-8">
        ...
        <p className="text-muted-foreground text-center mb-6">Join millions tracking their fitness</p>
          ...
          <div>
            ...
            <div className="mt-2 flex gap-1">
              {[...Array(4)].map((_, i) => (
                <div
                  key={i}
                  className={`h-1 flex-1 rounded-full ${i < passwordStrength ? "bg-primary" : "bg-secondary/30"}`}
                ></div>
              ))}
            </div>
          </div>
